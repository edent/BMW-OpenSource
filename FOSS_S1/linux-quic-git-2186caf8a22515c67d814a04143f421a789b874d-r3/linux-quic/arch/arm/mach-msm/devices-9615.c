...
static struct resource resources_hsusb[] = {
	...
	/* GPIO 79 is used as ethernet reset in ATM project
	 * no other GPIO was defined for USB_RESUME purpose yet */
#if 0
	{
...
struct platform_device msm9615_device_uart_gsbi3 = {
	.name	= "msm_serial_hsl",
	.id	= 1,
...
static struct resource resources_uart_gsbi4[] = {
  ...
  //07/24/2013 - change TX first -
  {
    .start = DMOV_HSUART_GSBI4_TX_CHAN, //DMOV_HSUART_GSBI4_RX_CHAN, // Channel for GSBI4_IN
    .end = DMOV_HSUART_GSBI4_RX_CHAN, //DMOV_HSUART_GSBI4_TX_CHAN, // Channel for GSBI4_OUT
    .name = "uartdm_channels",
    .flags = IORESOURCE_DMA ,
  },
  { // Cannot be changed .
    .start = DMOV_HSUART_GSBI4_TX_CRCI, //DMOV_HSUART_GSBI4_RX_CRCI, // CRCI for GSBI4_OUT
    .end = DMOV_HSUART_GSBI4_RX_CRCI, //DMOV_HSUART_GSBI4_TX_CRCI, // CRCI for GSBI4_IN
    .name = "uartdm_crci",
    .flags = IORESOURCE_DMA ,
  },
};
