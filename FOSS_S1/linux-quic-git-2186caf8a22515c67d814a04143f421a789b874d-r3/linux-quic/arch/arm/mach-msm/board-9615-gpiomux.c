...
/* GPIO[79]: ETH_RESET_N
  * Configure GPIO as OE, 8mA, NoPull-BitBang
  * hold ethernet chip reset (HW inverted)
  * 1 -> Reset, 0 -> Active
  */
static struct gpiomux_setting eth_reset_config = {
    .func = GPIOMUX_FUNC_GPIO,
    .drv = GPIOMUX_DRV_8MA,
    .pull = GPIOMUX_PULL_NONE,
...
/* cvo@peiker 18.09.2013 Begin: Add setting for GPIO82 (NAD2uC-NAD-RUNNING) */

static struct gpiomux_setting nad_running ={
        .func = GPIOMUX_FUNC_GPIO,
        .drv = GPIOMUX_DRV_2MA,
        .pull = GPIOMUX_PULL_NONE,
        .dir = GPIOMUX_OUT_LOW,
...
static struct msm_gpiomux_config msm9615_nad_running_configs[] __initdata = {
	{
		.gpio = 82,
		.settings = {
                        [GPIOMUX_ACTIVE] = &nad_running,
			[GPIOMUX_SUSPENDED] = &nad_running,
		},
	},
};

/* cvo@peiker 18.09.2013 End:   Add setting for GPIO82 (NAD2uC-NAD-RUNNING) */
...
static struct msm_gpiomux_config msm9615_eth_configs[] __initdata = {
    {
        .gpio      = 79,/* ETH_RESET_N */
        .settings = {
            [GPIOMUX_ACTIVE] = &eth_reset_config,
            [GPIOMUX_SUSPENDED] = &eth_reset_config,
        },
    },
};
...
int __init msm9615_init_gpiomux(void)
{
   ...
   msm_gpiomux_install(msm9615_eth_configs,
            ARRAY_SIZE(msm9615_eth_configs));
...
/* cvo@peiker 18.09.2013 Begin: Add setting for GPIO82 (NAD2uC-NAD-RUNNING) */
	msm_gpiomux_install(msm9615_nad_running_configs,
			ARRAY_SIZE(msm9615_nad_running_configs));
/* cvo@peiker 18.09.2013 End:   Add setting for GPIO82 (NAD2uC-NAD-RUNNING) */
