...
VREG_CONSUMERS(S3) = {
    ...
    /* @Peiker/QC - Supplies for TI TLV320AIC3104 */
...
/* @Peiker/QC - Consumers for offchip always on LDO */
#if 0
VREG_CONSUMERS(L3V0) = {
...
msm_rpm_regulator_init_data[] __devinitdata = {
    ...
    /* @Peiker/QC - Add dedicated 3V0 LDO */
    //RPM_LDO(L3V0,    1, 1, 0, 3000000, 3000000, NULL,      0, 0),
    /* @Peiker/QC - end LDO */
