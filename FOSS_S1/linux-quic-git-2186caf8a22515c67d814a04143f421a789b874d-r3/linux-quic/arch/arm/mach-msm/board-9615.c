...
/* @peiker/cvo 2012-01-07 : A added initialisation for PM_GPIO 1,3,4 and 5 */
	PM8018_GPIO_OUTPUT(1,	0,	LOW), /* OEM usable PM_GPIO */
	PM8018_GPIO_OUTPUT(3,	0,	LOW), /* OEM usable PM_GPIO */
	PM8018_GPIO_OUTPUT(4,	0,	LOW), /* OEM usable PM_GPIO */
	PM8018_GPIO_OUTPUT(5,	0,	LOW), /* OEM usable PM_GPIO */
/* @peiker/cvo 2013-01-07 : E added initialisation for PM_GPIO 3 and 4 */
};
...
/* @peiker/cvo 2013-01-22 : A Additional files in sysFS to read ADC on MPP-Pin 1,2 and 5 */
	{"mpp_1", ADC_MPP_1_ATEST_8, CHAN_PATH_SCALING1, AMUX_RSV1,
		ADC_DECIMATION_TYPE2, ADC_SCALE_DEFAULT},
	{"mpp_2", ADC_MPP_1_USB_SNS_DIV20, CHAN_PATH_SCALING1, AMUX_RSV1,
		ADC_DECIMATION_TYPE2, ADC_SCALE_DEFAULT},
	{"mpp_5", ADC_MPP_1_AMUX4, CHAN_PATH_SCALING1, AMUX_RSV1,
		ADC_DECIMATION_TYPE2, ADC_SCALE_DEFAULT},

	/*NOTE:
	change Arg2 according to below list, also if you change gain select CHAN_PATH_SCALING1 for 1:1 scaling. If 1:3 scaling is desired, use CHAN_PATH_SCALING2.
	ADC_MPP_1_ATEST_8 = 20 		=> MPP1 using 1/1 gain
	ADC_MPP_1_USB_SNS_DIV20 	=> MPP2 using 1/1 gain
	ADC_MPP_1_DCIN_SNS_DIV20 	=> MPP3 using 1/1 gain
	ADC_MPP_1_AMUX3 		=> MPP4 using 1/1 gain
	ADC_MPP_1_AMUX4 		=> MPP5 using 1/1 gain
	ADC_MPP_1_AMUX5 		=> MPP6 using 1/1 gain

	ADC_MPP_2_ATEST_8 = 40 		=> MPP1 using 1/3 gain
	ADC_MPP_2_USB_SNS_DIV20 	=> MPP2 using 1/3 gain
	ADC_MPP_2_DCIN_SNS_DIV20 	=> MPP3 using 1/3 gain
	ADC_MPP_2_AMUX3 		=> MPP4 using 1/3 gain
	ADC_MPP_2_AMUX4 		=> MPP5 using 1/3 gain
	ADC_MPP_2_AMUX5 		=> MPP6 using 1/3 gain
	*/
/* @peiker/cvo 2013-01-22 : E Additional ADC files in sysFS to read ADC on MPP-Pin 1,2 and 5 */
};
...
/** Configuration for TI TLV320AIC3x */
#ifdef CONFIG_SND_SOC_TLV320AIC3X

static struct aic3x_setup_data aic3x_gpio_config = {
		.gpio_func[0] = AIC3X_GPIO1_FUNC_DISABLED,
		.gpio_func[1] = AIC3X_GPIO2_FUNC_DISABLED,
};

static struct aic3x_pdata aic3x_i2c_platform_data = {
	.setup = &aic3x_gpio_config,
	.gpio_reset = 84,
};

static struct i2c_board_info aic3x_device_info[] __initdata = {
	{
		I2C_BOARD_INFO("tlv320aic3x", AIC36_I2C_SLAVE_ADDR),
		.platform_data = &aic3x_i2c_platform_data,
	}
};
...
static struct i2c_registry msm9615_i2c_devices[] __initdata = {
	{
		...
		aic3x_device_info,
		ARRAY_SIZE(aic3x_device_info),
	},
};
#endif /* CONFIG_SND_SOC_TLV320AIC3X */


/* @peiker/ol 2012-10-12 : A changed gsbi3 from SPI to UART for diag shell */
#ifdef PEIKER_SPI
static struct msm_spi_platform_data msm9615_qup_spi_gsbi3_pdata = {
	.max_clock_speed = 24000000,
};
#endif /* #ifdef PEIKER_SPI */
/* @peiker/ol 2012-10-12 : E changed gsbi3 from SPI to UART for diag shell */
