...
/* since 8 does not work we use 16 */
#define PERIODSIZE_16MS

#ifdef PERIODSIZE_16MS
# define PLAYBACK_PERIOD_SIZE	(128 * 2 * 2)
# define CAPTURE_PERIOD_SIZE	(128 * 2 * 2)
#endif

#ifdef PERIODSIZE_8MS
# define PLAYBACK_PERIOD_SIZE	(128 * 2)
# define CAPTURE_PERIOD_SIZE	(128 * 2)
#endif
